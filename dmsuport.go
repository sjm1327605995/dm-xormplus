...
func dm_hash(str string) string {
...
func dm_index_name(index *core.Index, tableName string) string {

	if !strings.HasPrefix(index.Name, "UQE_") &&
		!strings.HasPrefix(index.Name, "IDX_") {

		name := dm_hash(fmt.Sprintf("%v_%v", tableName, index.Name))
...
func (db *dm) CreateIndexSql(tableName string, index *core.Index) string {
	...
	idxName = dm_index_name(index, tableName)
...
func (db *dm) DropIndexSql(tableName string, index *core.Index) string {
	...
	if index.IsRegular {
		name = dm_index_name(index, tableName)
	} else {
		name = index.Name
	}
